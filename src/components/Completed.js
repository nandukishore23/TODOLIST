...
const Coc= () => {
  ...
  return (
    ...
    <div>
      ...
      <div className='Comp'><Dot style={{display:"inline-block", background:"#E7F8E9",}} size={33}/>Completed</div>
      {isFormOpen && (
        <AddItemForm
          isOpen={isFormOpen}
          onClose={() => {
      ...
      <div>
        {items.map((item, index) => (
          <Card key={index} item={item} onEdit={handleEditCard} />
                    ...
                    <button onClick={handleOpenForm} className='Addme3' style={{width:'96%'}}> +  Add New </button>
