...
import '../components/Inproggres.css';
  ...
  return (
    ...
    <div>
      ...
      {/* <div className='todo' ><Dot style={{display:"inline-block", background:"#EBEEFC",}} size={33}/>To Do</div> */}
        <div className='Inpo'><Dot style={{display:"inline-block", background:"#FDF2FA",}} size={33}/>In Progress</div>
      ...
      <div>
        {items.map((item, index) => (
          <Card key={index} item={item} onEdit={handleEditCard} />
                    ...
                    <button onClick={handleOpenForm} className='Addnew1' style={{width:'96%'}}> +  Add New </button>
